...
router.get('/stage/:id', authMiddleware, requireProjectAccess('stage', 'read'), getSingleStageByStageId) //tested
...
router.get('/activeStages/:id', authMiddleware, requireProjectAccess('stage', 'read'), getActiveStagesByProjectNumber) //tested
...
router.put('/stages/:id', authMiddleware, requireProjectAccess('stage', 'update'), updateStage) //tested
